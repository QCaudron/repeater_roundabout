...
L.marker([47.9781689000, -122.2078827000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>63</div>", iconSize: [25, 25]}) }).bindPopup('RR# 63 - WA7ACS (440.175)<br>').addTo(map);
