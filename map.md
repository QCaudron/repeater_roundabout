...
L.marker([47.4881800000, -121.9469766667], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>...</div>", iconSize: [25, 25]}) }).bindPopup('RR# 55 - K7LED (146.820)<br>RR# 56 - K7LED (224.120)<br>RR# 148 - WW7STR (147.080)<br>').addTo(map);
