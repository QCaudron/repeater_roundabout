...
L.marker([47.6240005500, -122.3150024400]).bindPopup('WW7PSR 146.960<br>WW7PSR 52.870<br>WW7PSR 440.775<br>').addTo(map);
...
L.marker([47.4510994000, -122.5540008500]).bindPopup('K7DK 440.950<br>').addTo(map);
