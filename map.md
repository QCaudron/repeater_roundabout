...
L.marker([47.6238380763, -122.3151844775], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>...</div>", iconSize: [25, 25]}) }).bindPopup('RR# 1 - WW7PSR (146.960)<br>RR# 2 - WW7PSR (52.870)<br>RR# 13 - W7ACS (442.875)<br>RR# 137 - W7ACS (442.875)<br>RR# 138 - W7ACS (443.475)<br>RR# 139 - W7ACS (443.650)<br>RR# 140 - W7ACS (440.600)<br>RR# 141 - W7ACS (443.200)<br>').addTo(map);
...
L.marker([47.5882474000, -122.3157438000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>...</div>", iconSize: [25, 25]}) }).bindPopup('RR# 134 - W7ACS (440.525)<br>RR# 135 - W7ACS (442.300)<br>').addTo(map);
