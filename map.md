...
L.marker([47.7642647150, -122.2810041150]).bindPopup('W7ACS 440.600<br>WA7FUS 224.220<br>').addTo(map);
...
L.marker([46.4879989600, -123.2144966150]).bindPopup('K7PG 147.060<br>W7WRG 224.080<br>').addTo(map);
...
L.marker([48.5889015200, -122.1525001500]).bindPopup('N7GDE 145.190<br>N7RIG 224.780<br>').addTo(map);
...
L.marker([47.2150993300, -123.1009979200]).bindPopup('N7SK 146.720<br>N7SK 443.250<br>N7SK 927.4125<br>').addTo(map);
...
L.marker([47.2040600000, -121.7956880000]).bindPopup('W7WRG 224.88<br>').addTo(map);
