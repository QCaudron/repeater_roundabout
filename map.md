...
L.marker([47.5417955714, -122.1093614286], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>...</div>", iconSize: [25, 25]}) }).bindPopup('RR# 44 - N9VW (443.325)<br>RR# 45 - KC7RAS (147.100)<br>RR# 69 - K7PP (443.400)<br>RR# 151 - WW7ATS (441.550)<br>RR# 152 - WW7STR (442.150)<br>RR# 153 - WW7STR (444.850)<br>RR# 154 - WW7STR (927.2125)<br>').addTo(map);
...
L.marker([47.4881800000, -121.9469766667], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>...</div>", iconSize: [25, 25]}) }).bindPopup('RR# 55 - K7LED (146.820)<br>RR# 56 - K7LED (224.120)<br>RR# 148 - WW7ATS (147.080)<br>').addTo(map);
...
L.marker([46.6268005400, -120.7389984050], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>...</div>", iconSize: [25, 25]}) }).bindPopup('RR# 129 - N7YRC (442.725)<br>RR# 131 - N7YRC (53.930)<br>').addTo(map);
L.marker([46.6305999800, -120.5350036600], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>130</div>", iconSize: [25, 25]}) }).bindPopup('RR# 130 - N7YRC (444.750)<br>').addTo(map);
L.marker([47.0289000000, -122.2995000000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>132</div>", iconSize: [25, 25]}) }).bindPopup('RR# 132 - N3KPU (145.230)<br>').addTo(map);
L.marker([47.1094700000, -122.5514800000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>133</div>", iconSize: [25, 25]}) }).bindPopup('RR# 133 - KE7YYD (442.750)<br>').addTo(map);
L.marker([47.3819999700, -122.2269973800], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>134</div>", iconSize: [25, 25]}) }).bindPopup('RR# 134 - K7CST (147.320)<br>').addTo(map);
L.marker([46.5139007600, -121.2080001800], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>135</div>", iconSize: [25, 25]}) }).bindPopup('RR# 135 - WA7SAR (146.860)<br>').addTo(map);
L.marker([46.0633010900, -121.4240036000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>136</div>", iconSize: [25, 25]}) }).bindPopup('RR# 136 - WA7SAR (147.080)<br>').addTo(map);
L.marker([46.5222015400, -120.3330001800], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>137</div>", iconSize: [25, 25]}) }).bindPopup('RR# 137 - WA7SAR (444.600)<br>').addTo(map);
L.marker([48.5602700000, -123.1199700000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>...</div>", iconSize: [25, 25]}) }).bindPopup('RR# 138 - N7JN (146.700)<br>RR# 140 - N7JN (443.450)<br>').addTo(map);
L.marker([48.6802780000, -122.8347200000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>139</div>", iconSize: [25, 25]}) }).bindPopup('RR# 139 - N7JN (224.480)<br>').addTo(map);
L.marker([48.6875000000, -122.3625000000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>...</div>", iconSize: [25, 25]}) }).bindPopup('RR# 141 - W7ECG (224.160)<br>RR# 142 - W7ECG (442.250)<br>').addTo(map);
L.marker([48.5136000000, -122.3708000000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>143</div>", iconSize: [25, 25]}) }).bindPopup('RR# 143 - W7ECG (442.825)<br>').addTo(map);
L.marker([48.2135000000, -122.7062000000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>144</div>", iconSize: [25, 25]}) }).bindPopup('RR# 144 - W7AVM (146.860)<br>').addTo(map);
L.marker([47.9744000000, -122.3976000000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>145</div>", iconSize: [25, 25]}) }).bindPopup('RR# 145 - W7AVM (147.220)<br>').addTo(map);
...
L.marker([47.7531760000, -122.9291100000], {icon: L.divIcon({className: 'custom-icon', html: "<div class='icon-label'>157</div>", iconSize: [25, 25]}) }).bindPopup('RR# 157 - K7DK (440.9500)<br>').addTo(map);
