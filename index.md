...
Then, check out the list of [123 participating repeaters](./repeaters) from across 44 radio groups that you'll play on during the contest. You can also [view the map](./map) to see where the repeaters are located.
